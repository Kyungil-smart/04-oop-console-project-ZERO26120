...
class Player
{
    ...
    public Player(PlayerJob job)
    {
        ...
        if (job == PlayerJob.Warrior)
        {
            ...
            Skills.Add(new Skill("돌진", 1.5, 5));
            Skills.Add(new Skill("화염 베기", 1.8, 10, StatusEffect.Burn, 30));
        ...
        else
        {
            ...
            Skills.Add(new Skill("독 안개", 1.2, 10, StatusEffect.Poison, 50));
            Skills.Add(new Skill("뇌창", 1.8, 5));
        }
    }
    ...
    public void GainExp(int amount, List<string> log)
    {
        Exp += amount;
        while (Exp >= 100)
        {
